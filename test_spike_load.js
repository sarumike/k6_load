...
export const options = {
   ...
   scenarios: {
    contacts: {
      ...
      startVUs: 0,
      stages: [
        { duration: '300s', target: 50 }, //base laod of 50 
        { duration: '60s', target: 100 }, //inject 1 minute spike 2x the load
        { duration: '300s', target: 50 }, // base load again
        { duration: '60s', target: 200 }, //inject spike 4x the load
        { duration: '300s', target: 50 }, //base load again
        { duration: '60s', target: 300 }, // inject spike 6x the laod
        { duration: '300s', target: 50 }, // base load again
        { duration: '60s', target: 0 }, //  stop VUs withjin 60s
      ],
      gracefulRampDown: '0s',
    },
  },
